...
public class ConxClient extends JFrame {
	...
	public ConxClient() {
		...
		setBounds(100, 100, 667, 415);
		contentPane = new JPanel();
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPane);
		GridBagLayout gbl_contentPane = new GridBagLayout();
		gbl_contentPane.columnWidths = new int[]{552, 0};
		gbl_contentPane.rowHeights = new int[]{48, 0, 0, 0};
		...
		contentPane.setLayout(gbl_contentPane);
				...
				gbl_panel_1.columnWidths = new int[] { 96, 65, 49, 38, 76, 97, 100, 105, 0 };
				...
				panel_1.setLayout(gbl_panel_1);
						...
						panel_1.add(lblNome, gbc_lblNome);
								...
								txfMeuNome.setColumns(10);
										...
										JLabel lblNewLabel = new JLabel("Endereco IP:");
												...
												txfIp.setColumns(10);
														...
														panel_1.add(lblNewLabel_1, gbc_lblNewLabel_1);
																...
																txfPorta.setColumns(10);
																		...
																		gbc_buttonConectar.anchor = GridBagConstraints.EAST;
																		gbc_buttonConectar.fill = GridBagConstraints.VERTICAL;
																		...
																		panel_1.add(buttonConectar, gbc_buttonConectar);
																				...
																				gbc_btnIniciarServidor.gridx = 7;
																				gbc_btnIniciarServidor.gridy = 1;
																				panel_1.add(btnIniciarServidor, gbc_btnIniciarServidor);
